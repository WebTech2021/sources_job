...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('dashboard.show')
                ...
                <li class="{{ request()->segment(2)=='home' ? 'active' :'' }} nav-item">
                    <a class="d-flex align-items-center" href="{{ route('admin.home') }}"><i
                        ...
                        ></i><span class="menu-title text-truncate" data-i18n="dashboard">{{__('Dashboard')}}</span></a>
                </li>
            @endcan
                        ...
                        @can('category.show')
                            <li class="{{ request()->segment(2)=='category'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{route('category.index')}}">
                                    <i class="fas fa-stream"></i><span class="menu-title text-truncate" data-i18n="Home"
                                    >{{__('Category')}}</span></a>
                            </li>
                        @endcan
                    ...
                    <ul class="menu-content">
                        @can('product.show')
                            <li class="{{ request()->segment(2)=='product'?'active':'' }} nav-item"><a
                                ...
                                ><i class="fas fa-baby-carriage"></i><span class="menu-title text-truncate"
                                                                           data-i18n="Home"
                                    >{{__('Product')}}</span></a>
                            </li>
                        @endcan
                        @can('product-feature.show')
                            <li class="{{ request()->segment(2)=='feature-product'?'active':'' }} nav-item"><a
                                ...
                                ><i class="fas fa-cart-plus"></i><span class="menu-title text-truncate"
                                                                       data-i18n="Home"
                        ...
                        @can('product-comments.show')
                            <li class="{{ request()->segment(2)=='product-comment'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{route('product-comment.index')}}">
                                    <i class="fas fa-comment-dots"></i><span class="menu-title text-truncate"
                                                                             data-i18n="Home"
                                    >{{__('Comments')}}</span></a>
                            </li>
                        @endcan
                        @can('product-reviews.show')
                            <li class="{{ request()->segment(2)=='review-product'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{route('product.getRatingReview')}}">
                                    <i class="far fa-star"></i><span class="menu-title text-truncate" data-i18n="Home"
                                    >{{__('Reviews')}}</span></a>
                            </li>
                        @endcan
                    </ul>
                    ...
                    <ul class="menu-content">
                        ...
                        @can('service-reviews.show')
                            <li class="{{ request()->segment(2)=='review-service'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{route('service.getRatingReview')}}">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="fas fa-store"></i> <span
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ Route::currentRouteName()=='organizations.report' ? 'active':'' }} nav-item">
                            <a class="d-flex align-items-center" href="{{route('organizations.report')}}"><i
                                    class="fa fa-list"
                                ></i><span
            ...
            @endif
            @can('order.show')
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="fa fa-shopping-cart"></i>
                        <span class="menu-title text-truncate" data-i18n="User">{{__('Order Management')}}</span></a>
                    <ul class="menu-content">
                        <li class="{{ Route::currentRouteName()=='order.product.list' ? 'active':'' }} nav-item">
                            <a class="d-flex align-items-center"
                               href="{{route('order.product.list', ['status'=>'all'])}}"
                            ><i class="fa fa-shopping-bag"></i><span class="menu-title text-truncate" data-i18n="Home"
                                >{{__('Orders')}}</span></a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="menu-content">
                        ...
                        @can('feature-request.show')
                            <li class="{{ request()->segment(2)=='feature-buyer-request'?'active':'' }} nav-item"><a
                                ...
                                ><i class="fas fa-arrows-alt"></i><span class="menu-title text-truncate"
                                                                        data-i18n="Home"
            ...
            @can('blog.show')
                <li class="{{ request()->segment(2)=='blog'?'active':'' }} nav-item"><a
                    ...
                    ><i class="fas fa-file-alt"></i><span class="menu-title text-truncate" data-i18n="Home"
                        >{{__('Blog')}}</span></a>
                </li>
            @endcan
            ...
            @if(Gate::check('web-setting.show') || Gate::check('setting-rules.show'))
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"> <i class="fab fa-first-order"></i>
                    ...
                    <ul class="menu-content">
                        ...
                        @endcan
                        <li class="{{ request()->segment(2)=='reason'?'active':'' }} nav-item">
                            <a class="d-flex align-items-center" href="{{route('reason.index')}}">
                                <i class="fas fa-tram"></i><span class="menu-title text-truncate"
                                                                 data-i18n="Home"
                                >{{__('Reason')}}</span></a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        ...
                        @can('self-statement.show')
                            <li class="{{ Route::currentRouteName()=='self.wallet.statement'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{route('self.wallet.statement')}}">
                                    <i class="far fa-file"></i><span class="menu-title text-truncate" data-i18n="Home"
                        ...
                        @can('account-transaction.show')
                            <li class="{{ request()->segment(2)=='account-transaction-details'||request()->segment(2)=='account-transaction'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center"
                                   href="{{ route('account.transaction.statement') }}"
                                >
                                    <i class="fas fa-exchange-alt"></i><span class="menu-title text-truncate"
                                                                             data-i18n="Home"
                        ...
                        @can('payment-request.show')
                            <li class="{{ request()->segment(2)=='wallet-request'?'active':'' }} nav-item">
                                <a class="d-flex align-items-center" href="{{ route('wallet.request') }}"><i
                                    ...
                                    >{{__('Payment Requests')}} <span
                                            class="menu-title text-truncate badge badge-pill bg-danger"
                                        >{{ \App\Models\AccountTransaction::where('status', 'pending')->where('sender_type', '!=', null)->count() }}</span></span></a>
                            </li>
                        @endcan
                        @can('all-wallet.show')
