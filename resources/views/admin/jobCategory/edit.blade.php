                ...
                <div class="card">
                    <div class="card-header border-bottom p-1">
                        <div class="head-label">
                            <h4 class="mb-0">{{__('Update Category')}}</h4>
                        </div>
                        ...
                        <form action="{{route('category.update',encrypt($category->id))}}" method="POST">
                            ...
                            <div class="row col-lg-12 mt-1">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input class="form-control" name="name" type="text" id="name" value="{{$category->name}}" placeholder="category name" required="">
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="name">Category Slug:</label>
                                    <input class="form-control" name="slug" type="text" id="slug" value="{{$category->slug}}" placeholder="" readonly>
                                </div>
                            </div>
