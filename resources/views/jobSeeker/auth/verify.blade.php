...
@section('page-title','account Verify')
@section('content')
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
            <h1 class="card-title font-weight-bold mb-1" style="text-align: center; text-decoration: underline"><b>Job Seeker Verify</b></h1>
...
{{--                        </form>--}}
                        <form class="d-inline" method="POST" action="{{ route('jobSeeker.verification.resend') }}">
                            @csrf
                            <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('আরেকটি অনুরোধ করুন') }}</button> ||
                        </form>
                        <form id="logout-form" action="{{ route('jobSeeker.logout') }}" method="POST" class="d-inline">
                            @csrf
