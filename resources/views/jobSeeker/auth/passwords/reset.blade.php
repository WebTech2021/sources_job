...
@section('page-title','job-seeker password reset')
@section('content')
	...
	<div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
		<div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
			...
			@endif
			<form class="auth-reset-password-form mt-2" action="{{ route('jobSeeker.password.update') }}" method="POST" novalidate="novalidate">
				@csrf
			...
			<p class="text-center mt-2"><a href="{{ route('jobSeeker.login') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg> Back to login</a></p>
		</div>
	</div>
