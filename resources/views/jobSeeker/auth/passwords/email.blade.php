...
@section('page-title','job-seeker Forgot Password')
@section('content')
	...
	<div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
		<div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
			...
			@endif
			<form class="auth-forgot-password-form mt-2" action="{{route('jobSeeker.password.email')}}" method="POST">
				@csrf
			...
			<p class="text-center mt-2"><a href="{{route('jobSeeker.login')}}"><i data-feather="chevron-left"></i> Back to login</a></p>
		</div>
	</div>
@endsection
