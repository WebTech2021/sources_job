                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-name">{{__('First Name')}}</label>
                                                        <input type="text" class="form-control" id="account-name"
                                                               name="first_name" placeholder="first name" value="{{old('first_name', $data->first_name)}}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-name">{{__('Last Name')}}</label>
                                                        <input type="text" class="form-control" id="account-name"
                                                               name="last_name" placeholder="last name" value="{{old('last_name', $data->last_name)}}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account-phone"
                                                               ...
                                                               name="phone" value="{{old('phone_number', $data->phone_number)}}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit"
