...
@section('page-title','Education Create')
@section('breadcrumb')
    <h2 class="content-header-title float-left mb-0">{{__('Create Education')}}</h2>
                ...
                <div class="card">
                    <div class="card-header border-bottom p-1">
                        <div class="head-label">
                            <h4 class="mb-0">{{__('Create Education')}}</h4>
                        </div>
                        ...
                        <form action="{{route('jobSeeker.education.store')}}" method="POST">
                            ...
                            <div class="row mt-2">
                                <div class="form-group col-sm-4">
                                    <div class="position-relative" data-select2-id="64">
                                        ...
                                        <select class="select2 form-select select2-hidden-accessible form-control"  tabindex="-1" aria-hidden="true" name="education_level" id="education_level" required="">
                                            ...
                                            <option value="psc" {{old('education_level') == 'psc' ? 'selected':'' }}>PSC/5 pass</option>
                                            <option value="jsc" {{old('education_level') == 'jsc' ? 'selected':'' }}>JSC/JDC/8 pass</option>
                                            <option value="secondary" {{old('education_level') == 'secondary' ? 'selected':'' }} >Secondary</option>
                                            <option value="higher_secondary" {{old('education_level') == 'higher_secondary' ? 'selected':'' }}>Higher Secondary</option>
                                            <option value="diploma" {{old('education_level') == 'diploma' ? 'selected':'' }}>Diploma</option>
                                            <option value="bachelor_honors" {{old('education_level') == 'bachelor_honors' ? 'selected':'' }}>Bachelor/Honors</option>
                                ...
                                <div class="form-group col-sm-4" id="education_board">
                                    <div class="position-relative" data-select2-id="64">
                                        ...
                                        <select class="select2 form-select select2-hidden-accessible form-control"  tabindex="-1" aria-hidden="true" name="education_board">
                                            ...
                                            <option value="Mymensingh" {{old('education_board') == 'Mymensingh' ? 'selected':'' }}>Mymensingh</option>
                                            <option value="Rajshahi" {{old('education_board') == 'Rajshahi' ? 'selected':'' }}>Rajshahi</option>
                                ...
                                <div class="form-group col-sm-4" id="group">
                                    ...
                                    <input class="form-control"  name="group" type="text" id="group"  placeholder="Concentration/Major/Group" value="{{old('group')}}">
                                </div>
                                <div class="form-group col-sm-4">
                                    <label for="institute">Institute Name:</label><span class="text-danger">*</span>
                                    <input class="form-control" required="" placeholder="Institute Name" name="institute_name" type="text" id="institute_name" value="{{old('institute_name')}}">
                                </div>
                                <div class="form-group col-sm-4">
                                    ...
                                    <select class="form-control select2" name="result" type="text" id="result">
                                        ...
                                        <option value="1st_class" {{old('result') == '1st_class' ? 'selected':'' }}>First Division/Class</option>
                                        <option value="2nd_class" {{old('result') == '2nd_class' ? 'selected':'' }}>Second Division/Class</option>
                                        <option value="3rd_class" {{old('result') == '3rd_class' ? 'selected':'' }}>Third Division/Class</option>
                                        <option value="grade" {{old('result') == 'grade' ? 'selected':'' }}>Grade</option>
                                    </select>
{{--                                    <input class="form-control" required="" name="result" type="number" id="result" value="{{old('result')}}">--}}
                                ...
                                <div class="form-group col-sm-4" id="mark">
                                    ...
                                    <input class="form-control"  name="mark" type="number"  value="{{old('mark')}}">
                                </div>
                                ...
                                <div class="form-group col-sm-4" id="scale">
                                    ...
                                    <input class="form-control"  placeholder="scale" name="scale" type="number"  value="{{old('scale')}}">
                                </div>
