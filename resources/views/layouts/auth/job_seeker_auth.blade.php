...
<head>
    ...
    <title>Login | Sources Job | Find Jobs</title>
...
{{--                        <img style=" margin: 20px 20px;" src="{{ asset('admin/app-assets/images/ico/sources1.png') }}"/>--}}
{{--                    </a>--}}
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('admin/app-assets/images/pages/Sign-up-banner.png') }}" alt="iamge" /></div>
                    </div>
                    <!-- /Left Text-->
                    @yield('content')
                </div>
