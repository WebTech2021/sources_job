...
class JobDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'job_responsibilities' => json_decode($this->job_responsibilities, false),
            'educational_requirements' => $this->educational_requirements,
            'additional_requirements' => json_decode($this->additional_requirements, false),
            'other_benefits' => json_decode($this->other_benefits, false),
